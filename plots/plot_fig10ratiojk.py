...
# =============================
df = pd.read_csv(DATA / "fig10_rilm_correlators.csv")
tau = df["tau"].values
...
dfT = pd.read_csv(DATA / "fig10_trials_correlators.csv")
...
ax1.errorbar(tau, C1_mc, yerr=dC1, fmt='o', ms=3, label=r"RILM $\langle x x\rangle$")
ax1.errorbar(tau, C2raw_mc, yerr=dC2raw, fmt='o', ms=3, label=r"RILM $\langle x^2 x^2\rangle$")
ax1.errorbar(tau, C3_mc, yerr=dC3, fmt='o', ms=3, label=r"RILM $\langle x^3 x^3\rangle$")
...
ax2.errorbar(tau, m1_mc, yerr=dm1_mc, fmt='o', ms=3, label=r"RILM $x$")
ax2.errorbar(tau, m2_mc, yerr=dm2_mc, fmt='o', ms=3, label=r"RILM $x^2$ (conn)")
ax2.errorbar(tau, m3_mc, yerr=dm3_mc, fmt='o', ms=3, label=r"RILM $x^3$")
...
plt.tight_layout()
plt.savefig(FIGS / "Figure_10ratiojk.png", dpi=250)
plt.show()